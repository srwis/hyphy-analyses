...
/** @module models.codon.SDT */

/**
 * @name models.codon.SDT.ModelDescription
 * @param {String} type
 * @param {String} code
 */
lfunction models.codon.SDT.ModelDescription(type, code) {
    ...
    mg_base[utility.getGlobalValue("terms.model.q_ij")] = "models.codon.SDT._GenerateRate";

    return mg_base;
}


lfunction models.codon.SDT._GenerateRate(fromChar, toChar, namespace, model_type, model) {
    return models.codon.SDT._GenerateRate_generic (fromChar, toChar, namespace, model_type,
    model[utility.getGlobalValue("terms.translation_table")],
        ...
        "omega_1", utility.getGlobalValue("terms.parameters.omega_1_ratio"),
        "omega_2", utility.getGlobalValue("terms.parameters.omega_2_ratio"),
...
/**
 * @name models.codon.SDT._GenerateRate
...
lfunction models.codon.SDT._GenerateRate_generic (fromChar, toChar, namespace, model_type, _tt, alpha, alpha_term, beta, beta_term, omega_1, omega_1_term, omega_2, omega_2_term, delta, delta_term, psi, psi_term) {
    ...
    if (diff_count == 1 || diff_count == 2 || diff_count == 3) {
        ...
        if (_tt[fromChar] != _tt[toChar]) {
            if (model_type == utility.getGlobalValue("terms.global")) {
                aa_rate = parameters.ApplyNameSpace(omega_1, namespace);
                (_GenerateRate.p[model_type])[omega_1_term] = aa_rate;
            } else {
                aa_rate = beta;
